...
s=s.replace('<script src="baked-player.js"></script><script src="lab-controls.js"></script>','<script src="rig-player.js?v=shore04"></script><script src="rig-controls.js?v=shore04"></script>')
